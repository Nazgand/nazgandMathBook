...
\begin{document}
	...
	$2\arcosh\pqty{\sqrt{2}}\approx 1.76274717403908605046521864995958461806$, above which any edge length is allowed in the case where both the incircle and circumcircle are horocycles.
